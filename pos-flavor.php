<?php
    ...
    $sqlProd = "SELECT * FROM products_tbl WHERE prod_id = '$id'";
    ...
    <div style="padding: 10px;">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <h4 style="color: black;">Select flavor for <strong><?php print $fetchProd['prod_name']; ?></strong>
                        </h4>
                        <br>
                        <div style="text-align: center;">
                            <form method="post" role="form" enctype="multipart/form-data">
                                <?php
                                    $sqlFlavors = "SELECT * FROM flavors_tbl WHERE flavor_prod_id = '$id'";
                                    $queryFlavors = mysqli_query($dbConString, $sqlFlavors);
                                    while($fetchFlavors = mysqli_fetch_assoc($queryFlavors)) {
                                ?>
                                <button class="btn" type="button" style="width: 30%; height: 100px; border-color: black;
                                color: black; box-shadow: 5px 7px #888888; margin-bottom: 10px; margin-right: 5px;" 
                                onclick="document.location.href='pos-add-cart.php?id=<?php print $id ?>&ordernumber=<?php print $on ?>&flavor=<?php print $fetchFlavors['flavor_id']; ?>'"><?php print $fetchFlavors['flavor_name']; ?></button>
                                <?php
                                }
                                ?>
                            </form>
