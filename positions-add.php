<?php
    ...
    if(isset($_POST['btnSave'])) {
        ...
        $sqlCheck = "SELECT pos_name FROM position_tbl WHERE pos_name = '$txtName'";
        ...
        if(mysqli_num_rows($queryCheck) > 0){
           ...
           $sqlAdd = "INSERT INTO position_tbl() VALUES (NULL, '$txtName', '$txtDescription', '$date', 0)";
    ...
    if(isset($_POST['btnSA'])) {
        ...
        if(mysqli_num_rows($queryCheck) > 0){
           ...
           $sqlAdd = "INSERT INTO position_tbl() VALUES (NULL, '$txtName', '$txtDescription', '$date', 0)";
            ...
            header("location: positions-add.php");
        }
    }
?>
