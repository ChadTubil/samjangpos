<?php
    ...
    if(isset($_POST['btnEnter'])) {
        ...
        $sqlCheck = "SELECT emp_number FROM employees_tbl WHERE emp_number = '$txtIDNumber' AND emp_position_id = '1' OR emp_position_id = '2' OR emp_position_id = '3'";
        $queryCheck = mysqli_query($dbConString, $sqlCheck);

        if(mysqli_num_rows($queryCheck) > 0){
            header("location: pos-cancel-cart.php");
        }else{
    ...
    <div style="padding: 10px;">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <h4 style="color: black;">Void Cart
                        </h4>
                        <br>
                        <form method="post" role="form" enctype="multipart/form-data">
                            <div style="padding-bottom: 5px;">
                                <label style="color: black;" >ID Number</label>
                                <input style="border-color: black; "type="text" class="form-control" name="IDNumber" required autofocus>
