                        ...
                        <div class="card" style="border: solid; border-color: black;">
                            <div class="card-body">
                                <div class="basic-form" >
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-12">
                                            <span style="float:left;"><p style="color: black;">Total Cost:</p></span><span style="float: right;"><h3 style="color: black;"><strong><?php print "₱".''.$TOTALCOST; ?></strong></h3></span>  
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-sm-12">
                                            <span style="float:left;"><p style="color: black;">Profit:</p></span><span style="float: right;"><h3 style="color: black;"><strong><?php print "₱".''.$PROFIT; ?></strong></h3></span>  
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                                $sqlOrder = "SELECT * FROM order_tbl WHERE order_isdel = 0 AND order_users_id = '$UID' AND order_status ='PAID' AND order_datecreated = '$cartdate'";
