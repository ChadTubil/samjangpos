<?php
    ...
    // Items Sold
    $sqlCountItems = "SELECT SUM(cart_qty) AS TOTALCOUNTITEMS FROM cart_tbl WHERE cart_users_id = '$UID' AND cart_datecreated = '$date'
    ...
    // Total Amount
    $sqlTotalAmount = "SELECT SUM(order_totalamount) AS TOTALAMOUNT FROM order_tbl WHERE order_users_id = '$UID' AND order_datecreated = '$date'
    ...
    // Total Discounted
    $sqlTotalDiscount = "SELECT SUM(order_totaldiscount) AS TOTALDISCOUNT FROM order_tbl WHERE order_users_id = '$UID' AND order_datecreated = '$date'
    AND order_status ='PAID'";
    ...
    if(isset($_POST['btnSearch'])) {
        ...
        header("location: daily-sales-result.php?date=".''.$txtDate);
    }

    //Cost Dine In
    $sqlTotalDineCost = "SELECT SUM(cart_dine) AS TOTALDINECOST FROM cart_tbl WHERE cart_users_id = '$UID' AND cart_datecreated = '$date'
    ...
    //Cost Take Out
    $sqlTotalTakeCost = "SELECT SUM(cart_take) AS TOTALTAKECOST FROM cart_tbl WHERE cart_users_id = '$UID' AND cart_datecreated = '$date'
                ...
                <div class="row page-titles mx-0" style="background-color: #f9f937; border: solid; border-color: black;">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4 style="color: black;">DAILY SALES REPORTS</h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                                $sqlOrder = "SELECT * FROM order_tbl WHERE order_isdel = 0 AND order_users_id = '$UID' AND order_status ='PAID' AND order_datecreated = '$date'";
