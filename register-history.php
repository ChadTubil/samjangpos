                ...
                <div class="row page-titles mx-0" style="background-color: #f9f937; border: solid; border-color: black;">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)" style="color: black;">Register</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card" style="border: solid; border-color: black;">
                            <div class="card-header">
                                <h4 class="card-title">Register Holder History</h4>
                                <!-- <span>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                                $sqlAttendance = "SELECT * FROM cashier_holder_tbl WHERE ch_users_id = '$UID'";
                                                $queryAttendance = mysqli_query($dbConString, $sqlAttendance);
                                                while($fetchAttendance = mysqli_fetch_assoc($queryAttendance)) {
                                            ?>
                                            <tr>
                                                <td style="color: black;"><?php print $fetchAttendance["ch_id_number"] ?></td>
                                                <td style="color: black;">
                                                    <?php 
                                                        $ATIN = $fetchAttendance["ch_id_number"];
                                                    ...
                                                    ?></td>
                                                <td style="color: black;"><?php print $fetchAttendance["ch_date"] ?></td>
                                                <td style="color: green;"><?php print $fetchAttendance["ch_login"] ?></td>
                                                <td style="color: red;"><?php print $fetchAttendance["ch_logout"] ?></td>
                                            </tr>
                                            <?php
                                                }
                                            ?>
