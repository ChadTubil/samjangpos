<?php
    ...
    if(isset($_POST['btnEnter'])) {
        ...
        if(mysqli_num_rows($queryCheck) > 0){
            $sqlCheck = "SELECT * FROM cashier_holder_tbl WHERE ch_id_number = '$txtId' AND ch_date = '$date'";
            $queryCheck = mysqli_query($dbConString, $sqlCheck);

            if(mysqli_num_rows($queryCheck) > 0){
                $message = "You are already logged in. Thank you!";
                echo "<script type='text/javascript'>alert('$message');</script>";
            }else{
                $sqlAdd = "INSERT INTO cashier_holder_tbl() VALUES (NULL, '$UID', '$txtIDNumber', '$time', '', 
                '$date', 0)";
    ...
    <div style="padding: 10px;">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <h4 style="color: black;">Open Register</h4>
                        <br>
                        <form method="post" role="form" enctype="multipart/form-data">
                            <div style="padding-bottom: 5px;">
                                ...
                                <p style="color: red;">Note: Enter the id number of store cashier to start.</p>
                            </div>
                            <br>
                            <div style="padding-bottom: 5px;">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <button type="button" onclick="document.location.href='dashboard.php'" class="btn btn-danger" style="width: 100%; height: 50px;">CANCEL</button>
                                    </div>
