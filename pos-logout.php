<?php
    ...
    if(isset($_POST['btnEnter'])) {
        ...
        $sqlCheck = "SELECT emp_number FROM employees_tbl WHERE emp_number = '$txtIDNumber' AND emp_position_id = '1' OR emp_position_id = '2' OR emp_position_id = '3' OR emp_position_id = '4'";
        $queryCheck = mysqli_query($dbConString, $sqlCheck);

        if(mysqli_num_rows($queryCheck) > 0){
            //Update Logout
            $sqlAttCheck = "SELECT * FROM cashier_holder_tbl WHERE  ch_id_number = '$txtIDNumber' AND ch_logout = '00:00:00'";
            $queryAttCheck = mysqli_query($dbConString, $sqlAttCheck);
            $fetchAttCheck = mysqli_fetch_assoc($queryAttCheck);
            $LOGOUT = $fetchAttCheck['ch_logout'];

            if($LOGOUT == '00:00:00'){
                $sqlUpdate = "UPDATE cashier_holder_tbl SET ch_logout = '$time' WHERE ch_id_number = '$txtIDNumber' AND ch_date = '$date' AND ch_logout = '00:00:00'";
            ...
            $message = "Invalid cashier id number. Please try again.";
            echo "<script type='text/javascript'>alert('$message');</script>";

            // header("location: pos-logout.php");
        }
    }
    ...
    <div style="padding: 10px;">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <h4 style="color: black;">Close Register</h4>
                        <br>
                        <form method="post" role="form" enctype="multipart/form-data">
                            <div style="padding-bottom: 5px;">
                                ...
                                <p style="color: red;">Note: Enter the id number of store cashier to close.</p>
                            </div>
                            <br>
                            <div style="padding-bottom: 5px;">
                                <div class="row">
                                    <div class="col-6">
                                        <button type="submit" name="btnEnter" class="btn btn-success" style="width: 100%; height: 50px;">SUBMIT</button>
                                    </div>
                                    <div class="col-6">
