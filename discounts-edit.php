<?php
    ...
    $id = $_GET['id'];
    $sqlDiscount = "SELECT * FROM discount_tbl WHERE disc_id = '$id'";
    ...
    if(isset($_POST['btnSave'])) {
        ...
        if(mysqli_num_rows($queryCheck) > 0){
            ...
            $sqlAdd = "UPDATE discount_tbl SET disc_name = '$txtName', disc_value = '$txtDiscount', disc_description = '$txtDescription'
            WHERE disc_id = '$id'";
                                        ...
                                        <div class="basic-form">
                                            <div class="form-row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input style="border-color: black; "type="text" class="form-control" value="<?php print $fetchDiscount['disc_name']; ?>" name="Name" required>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label style="color: black">Discount</label>
                                                    <select class="form-control" name="Discount" style="border-color: black;" required>
                                                        <option value="<?php print $fetchDiscount['disc_value']; ?>"><?php print $fetchDiscount['disc_value'].''."%"; ?></option>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea style="border-color: black; "type="text" class="form-control" name="Description"><?php print $fetchDiscount['disc_description']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
